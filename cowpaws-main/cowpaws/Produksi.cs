...
namespace cowpaws
{
    ...
    {
        public Produksi()               // constructor untuk inisialisasi objek dari kelas Produksi yang merupakan form Produksi
        {
            ...
            Populate();                 // mengisi DataGridView dengan data dari tabel t_produksi saat form Produksi diinisialisasi
        }
