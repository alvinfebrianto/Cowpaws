...
namespace cowpaws
{
    ...
    {
        public Cows()                   // constructor untuk inisialisasi objek dari kelas Cows yang merupakan form Cows
        {
            InitializeComponent();      // inisialisasi komponen pada form Cows
            Populate();                 // mengisi DataGridView dengan data dari tabel t_cows saat form Cows diinisialisasi
        }

        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\lenovo\Documents\Visual Studio 2015\Projects\cowpaws\cowpaws\db_cowpaws.mdf;Integrated Security=True");
        ...
        private void Search()       // method untuk fitur Filter
        {
            Con.Open();
