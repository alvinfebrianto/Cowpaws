...
namespace cowpaws
{
    ...
    {
        public Kesehatan()              // constructor untuk inisialisasi objek dari kelas Kesehatan yang merupakan form Kesehatan
        {
            ...
            Populate();                 // mengisi DataGridView dengan data dari tabel t_kesehatan saat form Kesehatan diinisialisasi
        }
